...
// B.B forward-declared classes: to inform the compiler about the existence of these classes 
// B.B without providing their complete definitions. 
class Viewer;
class FrameDrawer;
class Atlas;
class LocalMapping;
...
public:
    ...
    void TEST_EvaluateSuperpoints(const cv::InputArray &_image);
...
protected:
    ...
    //Motion Model
    // bool mbVelocity{false}; commented by B.B
