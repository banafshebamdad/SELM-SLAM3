...
namespace ORB_SLAM3 {
    ...
    float Settings::readParameter<float>(cv::FileStorage& fSettings, const std::string& name, bool& found, const bool required) {
        // B.B name: name of the parameter read from yaml file (fSettings), e.g. ORBextractor.iniThFAST
        cv::FileNode node = fSettings[name]; // B.B value of the parameter
        
        // cout << "B.B " << name << "->" << node.type() << "<-" << " Value: " << node.real() << endl;
    ...
    bNeedToUndistort_(false), bNeedToRectify_(false), bNeedToResize1_(false), bNeedToResize2_(false) {
        ...
        readORB(fSettings); // B.B !!! Achtung Achtung !!! 
    ...
    void Settings::readCamera1(cv::FileStorage &fSettings) {
        ...
        if (cameraModel == "PinHole") {
            ...
            // B.B 
            // cout << "B.B fx, fy, cx, cy: " << fx << ", " << fy << ", " << cx << ", " << cy << endl << "Press Enter:";
            // cin.get();
    ...
    void Settings::readImageInfo(cv::FileStorage &fSettings) {
        ...
        // B.B
        // cout << "B.B Camera Hight & width from yaml: " << originalRows << ", " << originalCols << endl << "Press Enter..." << endl;
        // cin.get();
    ...
    void Settings::readRGBD(cv::FileStorage& fSettings) {
        ...
        // B.B 
        // cout << "B.B depthMapFactor_, thDepth_, b_, bf_: " << depthMapFactor_ << ", " << thDepth_ << ", " << b_ << ", " << bf_ << endl << "Press Enter...";
        // cin.get();
    }
    ...
    void Settings::readORB(cv::FileStorage &fSettings) {
        ...
        // B.B
        // cout << "B.B nFeatures_: " << nFeatures_ << endl;
