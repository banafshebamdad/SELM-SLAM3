    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    // B.B
    // cout << endl << "B.B setting file node version (yaml):" << node.string() << endl << "Press Enter to continue...";
    // cin.get();

    if(!node.empty() && node.isString() && node.string() == "1.0") {

        // cout << endl << "B.B In System::System constructor. yaml file version is 1.0. Press Enter to continue...";
        // cin.get();
        ...
        // cout << endl << "B.B In System::System constructor. mStrLoadAtlasFromFile->" << mStrSaveAtlasToFile << "<-" << endl;
        // cout << endl << "B.B In System::System constructor. mStrSaveAtlasToFile->" << mStrSaveAtlasToFile << "<-" << endl;

        cout << "B.B Settings are as follows:" << endl;
        cout << (*settings_) << endl;
    ...
    cout << "B.B In System::system constructor. Initialize the Tracking thread. Press Enter ...";
    // cin.get();
    cout << "Seq. Name: " << strSequence << endl;

    // B.B !!! Achtung !!! suspicious ... Initializing Superpoint detector...
    mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
                             mpAtlas, mpKeyFrameDatabase, strSettingsFile, mSensor, settings_, strSequence);

    //Initialize the Local Mapping thread and launch
    cout << "B.B In System::system constructor. Initialize the Local Mapping thread and launch. Press Enter ...";
    // cin.get();
    ...
    cout << endl << "B.B In System::system constructor. Initialize the Loop Closing thread and launch. Press Enter ...";
    // cin.get();
    ...
    cout << endl << "B.B In System::system constructor. Set pointers between threads. Press Enter ...";
    // cin.get();
    ...
    cout << endl << "B.B In System::system constructor. Initialize the Viewer thread and launch. Press Enter ...";
    // cin.get();

    if(bUseViewer)
    //if(false) // TODO
    {
        // B.B This section was wanted by Banafshe."
        // B.B initializes and sets up a Viewer object and related threads and connections 
        mpViewer = new Viewer(this, mpFrameDrawer, mpMapDrawer, mpTracker, strSettingsFile, settings_);
        mptViewer = new thread(&Viewer::Run, mpViewer); // B.B creates a new thread that runs the Run method of the mpViewer object.
         
        mpTracker->SetViewer(mpViewer); // B.B sets the mpViewer object as the viewer for mpTracker.
...
/**
 * B.B https://github.com/strasdat/Sophus
 * This is a c++ implementation of Lie groups commonly used for 2d and 3d geometric problems (i.e. for Computer Vision or Robotics applications). 
 * Among others, this package includes the special orthogonal groups SO(2) and SO(3) to present rotations in 2d and 3d as well as the special Euclidean group SE(2) and SE(3) 
 * to represent rigid body transformations (i.e. rotations and translations) in 2d and 3d.
*/
// B.B System::TrackRGBD method in ORB-SLAM3 return cv::Mat.
Sophus::SE3f System::TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename) {
    ...
    if(settings_ && settings_->needToResize()) {
        ...
        cout << endl << "B.B in System::TrackRGBD. Images should NOT be resized.";
    }
...
void System::SaveTrajectoryTUM(const string &filename) {
    ...
    // B.B The following code snipper was added by Banafshe. Separate this into a distinct method.
    // std::ofstream lost_frames("/home/banafshe/SUPERSLAM3/my_logs/Tracking/bb_lostframes.txt");
    // if (lost_frames.is_open()) {
    //     int frame_num = 0;
    //     for (bool item : mpTracker->mlbLost) {
    //         lost_frames << "Frame " << frame_num << "("<< mpTracker->mlFrameTimes << "): " << (item ? "Lost" : "") << endl;
    //         frame_num++;
    //     }

    //     lost_frames.close();
    //     cout << "Lost Frame Log file created successfully in the following file." << endl;
    //     cout << "/home/banafshe/SUPERSLAM3/my_logs/Tracking/bb_lostframes.txt" << endl;
    //     cout << "Pres Enter...";
    //     cin.get();
    // }
