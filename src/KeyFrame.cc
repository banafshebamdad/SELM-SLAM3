...
/**
 * B.B
 * creating and initializing a KeyFrame object based on the data and attributes of a corresponding Frame, 
 * along with additional map and database information. 
*/
...
void KeyFrame::ComputeBoW() {
    ...
    cout << endl << "B.B At the beginning of the KeyFrame::ComputeBoW. mBowVec.empty(): " << mBowVec.empty() << ", mFeatVec.empty(): " << mFeatVec.empty() << ", Press Enter...";
    // cin.get();

    // B.B checks two member variables of the KeyFrame class
    if(mBowVec.empty() || mFeatVec.empty()) {

        // B.B converts Descriptors to a vector of matrices
        ...
        cout << endl << "B.B in KeyFrame::ComputeBoW. mBowVec.empty(): " << mBowVec.empty() << ", mFeatVec.empty(): " << mFeatVec.empty() << ", Press Enter...";
        // cin.get();
    }

    cout << endl << "B.B in KeyFrame::ComputeBoW. Everything is commented by me. press Enter ...";
    // cin.get();
}
